...
def movie_detail(request, movie_id):
    ...
    return render(request, 'movie_detail.html', {'movie': movie, 'reviews': reviews,'user_review':user_review,'comments':comments,'in_wishlist':in_wishlist , 'avg_rating':avg_rating})
